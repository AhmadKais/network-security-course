...
📎 **דף תזכורת מרוכז** (כל הרשתות בעמוד אחד, לחזרה לפני בחינה): [תזכורת רשתות](Chapter_00b_Networking_Reminder/study_material.md) · **סקירה ופתרון שאלון:** [פרק ⁦0⁩](Chapter_00_Overview/study_material.md)
