...
_⁦10⁩ שעות עיוני + ⁦2⁩ מעשי · שבועות ⁦4⁩–⁦6⁩_
...
### רמות הרשאה בפירוט, ותצוגות תפקיד
...
### עוד על שלושת שירותי הניטור

**שמונה רמות החומרה של ⁦Syslog⁩** – כדאי להכיר אותן, כי בוחרים לפיהן מה לשלוח לשרת. הן, מהחמורה ביותר לפחותה: ⁦0⁩ – ⁦Emergency⁩ (המערכת אינה שמישה), ⁦1⁩ – ⁦Alert⁩ (נדרשת פעולה מיידית), ⁦2⁩ – ⁦Critical, 3⁩ – ⁦Error⁩ (למשל ממשק שנפל), ⁦4⁩ – ⁦Warning, 5⁩ – ⁦Notification⁩ (אירוע רגיל אך חשוב, כמו שינוי הגדרות), ⁦6⁩ – ⁦Informational, 7⁩ – ⁦Debugging⁩ (פלט מפורט מאוד לאיתור תקלות). מנמוניקה נפוצה לזכירת הסדר באנגלית: ⁦Every Awesome Cisco Engineer Will Need Ice-cream Daily.⁩

ל-**⁦NTP⁩** יש מושג בשם **⁦Stratum⁩** – "מרחק" ממקור הזמן המדויק. ⁦Stratum 0⁩ הוא שעון אטומי או ⁦GPS, Stratum 1⁩ הוא שרת שמחובר אליו ישירות, וכן הלאה. ככל שה-⁦Stratum⁩ נמוך יותר, המקור אמין יותר. חשוב גם **לאמת** את מקור הזמן (`⁦ntp authenticate⁩`), אחרת תוקף יכול לזייף לנתב את השעה ובכך לשבש לוגים ותעודות.

ב-**⁦SNMPv3⁩** יש שלוש רמות אבטחה שכדאי להכיר: **⁦noAuthNoPriv⁩** (בלי אימות ובלי הצפנה – החלש), **⁦authNoPriv⁩** (אימות בלבד), ו-**⁦authPriv⁩** (גם אימות וגם הצפנה – המומלץ). המילה "⁦auth"⁩ מציינת אימות (מי שולח) ו-"⁦priv"⁩ מציינת פרטיות/הצפנה (שאף אחד לא יקרא). זה ההבדל המהותי מ-⁦v1/v2c⁩, שאין בהם לא אימות אמיתי ולא הצפנה.
...
**⁦1.⁩** באיזו פקודה נכנסים ממצב ⁦User EXEC⁩ למצב ⁦Privileged⁩?
- א. `⁦configure terminal⁩` · ב. `⁦enable⁩` · ג. `⁦login⁩` · ד. `⁦privilege 15⁩`

<details><summary>תשובה</summary>**ב** – `⁦enable⁩`. הסימן משתנה מ-`>` ל-`#`.</details>

**⁦2.⁩** מדוע `⁦enable secret⁩` עדיף על `⁦enable password⁩`?
- א. הוא ארוך יותר · ב. הוא נשמר מגובב (⁦Hash)⁩ ולא בטקסט גלוי · ג. הוא מהיר יותר · ד. אין הבדל

<details><summary>תשובה</summary>**ב** – `⁦secret⁩` = גיבוב ⁦MD5⁩ חד-כיווני. `⁦password⁩` = טקסט גלוי.</details>

**⁦3.⁩** מה מספקת הפקודה `⁦service password-encryption⁩`?
- א. הגנה חזקה מפני תוקף · ב. הצפנה חלשה (⁦Type 7)⁩ הפיכה – רק נגד הצצה מעבר לכתף · ג. גיבוב ⁦SHA⁩ · ד. חסימת סיסמאות

<details><summary>תשובה</summary>**ב** – ⁦Type 7⁩ נשבר בשנייה באתרים חינמיים. ההגנה האמיתית היא `⁦secret⁩`.</details>

**⁦4.⁩** מדוע ⁦Telnet⁩ מסוכן ומה מחליף אותו?
- א. הוא איטי; ⁦FTP⁩ · ב. הוא שולח הכול כולל הסיסמה בטקסט גלוי; ⁦SSH⁩ מצפין · ג. הוא ישן; ⁦HTTP⁩ · ד. אין בעיה

<details><summary>תשובה</summary>**ב** – מי שמאזין רואה את הסיסמה. ⁦SSH⁩ מצפין את כל הסשן.</details>

**⁦5.⁩** אילו שני דברים חייבים להיות מוגדרים כדי ליצור מפתח ⁦RSA⁩ ל-⁦SSH⁩?
- א. ⁦IP⁩ ו-⁦VLAN⁩ · ב. ⁦hostname⁩ ו-⁦ip domain-name⁩ · ג. סיסמה ו-⁦banner⁩ · ד. ⁦NTP⁩ ו-⁦Syslog⁩

<details><summary>תשובה</summary>**ב** – המפתח נקרא ⁦hostname.domain⁩, אז שניהם חייבים להיות מוגדרים.</details>

**⁦6.⁩** מהי מטרת `⁦login block-for⁩`?
- א. לחסום ⁦Telnet⁩ · ב. להאט/לחסום התקפת ניחוש סיסמאות (⁦Brute Force)⁩ אחרי כמה כשלונות · ג. לכבות פורט · ד. לגבות הגדרות

<details><summary>תשובה</summary>**ב** – אחרי ⁦X⁩ כשלונות בזמן נתון, הנתב "ננעל" ולא מקבל ניסיונות.</details>

**⁦7.** Privilege 15⁩ פירושו:
- א. קריאה בלבד · ב. גישת מנהל מלאה · ג. משתמש אורח · ד. פורט חסום

<details><summary>תשובה</summary>**ב** – רמה ⁦15⁩ = כל הפקודות. רמה ⁦1 = User EXEC⁩ בלבד.</details>

**⁦8.⁩** מה תפקיד שרת ⁦NTP⁩ באבטחה?
- א. לחלק כתובות · ב. לסנכרן שעון מדויק – בלעדיו לא ניתן לתאם אירועים בין מכשירים ולחקור תקלות · ג. להצפין · ד. לחסום וירוסים

<details><summary>תשובה</summary>**ב** – יומנים בלי זמן מסונכרן הם חסרי ערך לחקירה.</details>

**⁦9.⁩** מהו ⁦Syslog⁩?
- א. פרוטוקול הצפנה · ב. שרת/מנגנון לאיסוף מרכזי של הודעות אירוע מהמכשירים · ג. סוג של סיסמה · ד. חומת אש

<details><summary>תשובה</summary>**ב** – ריכוז לוגים מכל הציוד למקום אחד, לניטור וחקירה.</details>

**⁦10.⁩** למה מכבים שירותים מיותרים בנתב (⁦Hardening)⁩?
- א. לחסוך חשמל · ב. כל שירות פתוח הוא "דלת" נוספת לתקיפה – מצמצמים את שטח התקיפה · ג. להאיץ · ד. חובה חוקית

<details><summary>תשובה</summary>**ב** – `⁦AutoSecure⁩` עושה זאת אוטומטית. פחות שירותים = פחות פגיעויות.</details>
...
ת: כי זה אלגוריתם הפיך וישן (וריאציה על ⁦Vigen⁩è⁦re).⁩ הוא מגן רק מפני מישהו שמציץ מעבר לכתף בזמן שאתם צופים בקונפיג – לא מפני תוקף אמיתי. ה"חוזק" האמיתי הוא ב-`⁦secret⁩` (גיבוב).
